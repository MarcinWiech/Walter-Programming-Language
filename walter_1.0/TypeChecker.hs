...
-- Type environment for a function
type TM = (String, [(String, T_)])
-- Type enviroment for the program
type TE = [TM]

-- given a funciton name and an env(Environment): returns True if the function has an env initialized, false otherwise
...
-- takes a VarInit_ definition and returns a new instance of TypeVariable
...
-- give a Var_ definition returns a TypeVariable definition
varToM :: Var_ -> (String, T_)
varToM (Var_ varName varType) = (varName, varType)

-- given a TypeEnvironment and a variable name: returns True if the variable is in the scope of that env
...
-- given a TypeEnvironment and a function name returns the env initialized to the name of that variable
...
-- given a function env and a varname: returns True if the variable is in the scope of the env
...
-- takes a list of FuncDeclaration and starts type evaluation expecting Main as the head of the list, then dispatches type checking routines.
...
-- executes type checking to a maths expression, with the information available in the given env
...
-- executes type checking to a comparable expression expression, with the information available in the given env
...
-- executes type checking to a comparable expression, with the information available in the given env
...
-- executes type checking to a assignment expression, with the information available in the given env
...
-- executes type checking to the components of an output pattern, with the information available in the given env
